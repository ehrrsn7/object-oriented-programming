...
- **f**: The user may perceive the software to be unreliable and untrustworthy.
- **f**: The software may work on less systems than the user needs.
- **f**: The software may be vulnerable to malicious attacks compromising the user's system or his confidential data.
