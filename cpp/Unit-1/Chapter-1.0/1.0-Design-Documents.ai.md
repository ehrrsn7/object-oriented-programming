...
readBoard(fileName, board, xTurn){.indent-4}\
{.indent-4}\
&emsp;fin(fileName){.indent-4}\
&emsp;&emsp;IF fin.fail(){.indent-4}\
&emsp;&emsp;PUT error{.indent-4}\
{.indent-4}\
&emsp;numXoverO = 0{.indent-4}\
&emsp;FOR row = 0...2{.indent-4}\
&emsp;&emsp;FOR col = 0...2 <span style="border: 2px solid black; padding: 0.4em">Read the 9 symbols from the file</span>{.indent-4}\
&emsp;&emsp;&emsp;READ board[row][col]{.indent-4}\
&emsp;&emsp;&emsp;IF board[row][col] = X{.indent-4}\
&emsp;&emsp;&emsp;&emsp;numXoverO + 1{.indent-4}\
&emsp;&emsp;&emsp;IF board[row][col] = O{.indent-4}\
&emsp;&emsp;&emsp;&emsp;numXoverO - 1 <span style="border: 2px solid black; padding: 0.4em">Keep track of the number of X's and O's</span>{.indent-4}\
{.indent-4}\
   xTurn ← (numXoverO == 0)
