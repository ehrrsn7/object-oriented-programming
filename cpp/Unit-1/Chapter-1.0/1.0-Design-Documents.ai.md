...
&emsp;numXoverO = 0\
&emsp;FOR row = 0...2\
&emsp;&emsp;FOR col = 0...2 <------ <span style="border: 2px solid black; padding: 1em">Read the 9 symbols from the file</span>\
...
&emsp;&emsp;&emsp;&emsp;numXoverO - 1 <----------- <span style="border: 2px solid black; padding: 1em">Keep track of the number of X's and O's</span>\
\
   xTurn ← (numXoverO == 0)
