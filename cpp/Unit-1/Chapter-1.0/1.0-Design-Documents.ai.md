...
<div style="page-break-after: true"></div>

| Part | Purpose {.rvhs-green-header-table style="border-top: 2px solid black; border-bottom: 2px solid black"}
| :--: | :--
...
## 1. Problem description {style="page-break-before: always"}
...
## 2. Design overview {style="page-break-before: always"}
...
## 3. Interface design {style="page-break-before: always"}
...
| Input value {.rvhs-green-header-table .gray-box} | How the program responds
| :-- | :--
| s {.rvhs-green-header-table .gray-box} | Save the current board to a file
| e {.rvhs-green-header-table .gray-box} | Edit a square on the board
| q {.rvhs-green-header-table .gray-box} | Quit the game

One example error is:
| `Error message` {.rvhs-green-header-table .gray-box} | When the message appears
| :-- | :--
| `Unable to open file file.txt for reading.` {.gray-box} | File is missing or otherwise unavailable for reading


## 4. Structure chart {style="page-break-before: always"}
...
[Structure Chart (Mermaid Diagram)](<1.0-Structure-Chart-Mermaid-Diagram.md>)
...
> numXoverO = 0
> > FOR row = 0...2
> > > FOR col = 0...2 [Read the 9 symbols from the file]{style="border: 2px solid black; padding: 0.4em"}
> > > > READ board[row][col]\
> > > > IF board[row][col] = X
> > > > > numXoverO + 1
>
> > > > IF board[row][col] = O
> > > > > numXoverO - 1 [Keep track of the number of X's and O's]{style="border: 2px solid black; padding: 0.4em"}
>
> xTurn ← (numXoverO == 0)
...
| Coordinate {.rvhs-green-header-table .center}
| :--
| row
| col
...
| Token {.rvhs-green-header-table .center} | Meaning
| :--
...
| Error | Condition | Handling {.rvhs-green-header-table}
| :-- | :-- | :--
