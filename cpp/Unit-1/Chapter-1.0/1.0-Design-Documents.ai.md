...
\
&emsp;fin(fileName)\
&emsp;&emsp;IF fin.fail()\
&emsp;&emsp;PUT error\
\
&emsp;numXoverO = 0\
&emsp;FOR row = 0...2\
&emsp;&emsp;FOR col = 0...2 <span style="border: 2px solid black; padding: 0.4em">Read the 9 symbols from the file</span>\
&emsp;&emsp;&emsp;READ board[row][col]\
&emsp;&emsp;&emsp;IF board[row][col] = X\
&emsp;&emsp;&emsp;&emsp;numXoverO + 1\
&emsp;&emsp;&emsp;IF board[row][col] = O\
&emsp;&emsp;&emsp;&emsp;numXoverO - 1 <span style="border: 2px solid black; padding: 0.4em">Keep track of the number of X's and O's</span>\
\
   xTurn ← (numXoverO == 0)
