...
| Input value | How the program responds {.steel-blue-header-table} |
| :-- | :-- |
| s | Save the current board to a file |
| e | Edit a square on the board |
| q | Quit the game |

One example error is:
| Error message | When the message appears {.steel-blue-header-table .gray-box} |
| :-- | :-- |
| Unable to open file file.txt for reading. {.gray-box} | File is missing or otherwise unavailable for reading {.gray-box} |
