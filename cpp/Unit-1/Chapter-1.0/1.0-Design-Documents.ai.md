...
\
   numXoverO = 0\
   FOR row = 0...2\
      FOR col = 0...2 <------ <span style="border: 2px solid black; padding: 1em">Read the 9 symbols from the file</span>\
         READ board[row][col]\
         IF board[row][col] = X\
            numXoverO + 1\
         IF board[row][col] = O\
            numXoverO - 1 <----------- <span style="border: 2px solid black; padding: 1em">Keep track of the number of X's and O's</span>\
\
   xTurn ← (numXoverO == 0)
