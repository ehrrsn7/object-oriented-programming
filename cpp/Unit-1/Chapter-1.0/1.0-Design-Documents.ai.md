...
<h2>Example 1.0 - Tic-Tac-Toe Design Document</h2>
...
<p>This demo is meant to illustrate a complete design document for a program approaching the complexity of what one would expect to see in CS 124.P,/p>
...
<p>Write a design document for a simple game to play Tic-Tac-Toe. The game should be able to allow two users to play the game and the program should persist a game in a file.P,/p>
...
<p>The important components of the design document are presented in the preceding section. It is important to observe how each section addresses a different aspect of the overall design.P,/p>
...
<p>As a challenge, see if you can complete a design document for a project you have worked on in a previous semester. Pay special attention to the new sections (Design Overview, Interface Design, Data-structures, File Format, and Error Handling).P,/p>
