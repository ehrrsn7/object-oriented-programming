...
| Error message | When the message appears {.steel-blue-header-table} |
| :-- | :-- |
| Unable to open file file.txt for reading. | File is missing or otherwise unavailable for reading |
