...
&emsp;&emsp;FOR col = 0...2`{ .indent-4 } <span style="border: 2px solid black; padding: 0.4em">Read `the 9 symbols from the file</span>\
...
&emsp;&emsp;&emsp;&emsp;numXoverO - 1`{ .indent-4 } <span style="border: 2px solid black; padding: 0.`4em">Keep track of the number of X's and O's</span>\
`{` .indent-4 }\
   xTurn ← (numXoverO == 0)
