...
int main()
{
    int value; // overload() with an integer by-reference
    overload(x);
    return;
}
```
...
> 
> | :---:
> | **Two integers** | <input style="min-height: 200px; min-width: 400px"> |
> | **Two characters** | <input style="min-height: 200px; min-width: 400px"> |
> | **Two floats** | <input style="min-height: 200px; min-width: 400px"> |
> | **Two strings** | <input style="min-height: 200px; min-width: 400px"> |
> 
> ## Problem 4 
> 
