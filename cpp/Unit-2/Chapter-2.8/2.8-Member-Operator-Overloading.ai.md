...
> | :--: | --:
> | 1. | `lhs + rhs` | <input> | <input> | <input>
> | 2. | `lhs += rhs` | <input> | <input> | <input>
> | 3. | `lhs++` | <input> | <input> | <input>
> | 4. | `++lhs` | <input> | <input> | <input>
> | 5. | `lhs == rhs` | <input> | <input> | <input>
> | 6. | `lhs << rhs` | <input> | <input> | <input>
> | 7. | `lhs >> rhs` | <input> | <input> | <input>
> | 8. | `-lhs` | <input> | <input> | <input>
> 
