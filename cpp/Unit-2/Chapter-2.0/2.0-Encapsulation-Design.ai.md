...
> 
> Original file: `2.0-Encapsulation-Design.pdf`
> 
...
- Private member function: $\qquad$
- Private member variable: $\qquad$
- Class name: $\qquad$
- Public member variable: $\qquad$
- Public member function: $\qquad$
...
- The measure of information interchange between functions $\qquad$
- A collection of tools to facilitate OO design $\qquad$
- The process of creating a protective layer around data $\qquad$
- The data associated with a class $\qquad$
- A subroutine or procedure associated with a class $\qquad$
- The name of a function designed to access data in a class $\qquad$
- The definition for a new data type $\qquad$
- The name of an instantiated class $\qquad$
- The name of a function designed to alter data in a class $\qquad$
- The process of breaking a large problem into smaller ones $\qquad$
- The extent in which a function does one thing only $\qquad$
