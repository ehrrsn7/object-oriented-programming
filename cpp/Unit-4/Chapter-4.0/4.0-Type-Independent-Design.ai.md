...
> 
> Original file: `4.0-Type-Independent-Design.pdf`
> 
> Generated: 2025-08-03 16:17:39
...
A template is
a mechanism in $\mathrm{C}++$ allowing a programmer to develop a function to work with generic data types
...
The final step in the design process is to replace all references to the stand-in data type (such as floats) with the template code. There are several ways to do this: use a void pointer (void *) as the data type (see Chapter 4.1) "use the template mechanism built into $\mathrm{C}++$ (see Chapter 4.2 and 4.3 ).
